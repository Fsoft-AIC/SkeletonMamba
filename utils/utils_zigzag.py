...
import numpy as np
GROUP_JOINTS = np.array([0, 3, 6, 9, 12, 15,  # body and head
                        9, 14, 17, 19, 21, 23,  # left arm
                        9, 13, 16, 18, 20, 22,  # right arm
                        3, 0, 1, 4, 7, 10, # right leg
                        3, 0, 2, 5, 8, 11]) # left leg
GROUP_JOINTS_REVERSE = np.array([0, 20, 26, 1, 21, 27, 2, 22, 28, 3, 23, 29, 4, 13, 7, 5, 14, 8, 15, 9, 16, 19, 17, 11]) 
# body and head group is in the midde
# there are 8 paths
BODY_PATHS = np.array([[1,2,0,3,4], 
                        [2,1,0,3,4],
                        [1,2,0,4,3],
                        [2,1,0,4,3],
                        [3,4,0,1,2],
